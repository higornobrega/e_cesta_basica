...
export function New() {
    ...
    async function handlePoolCreate() {
        ...
        try {
            ...
            const fcuNumber = (Number(fcuReplaceVirgulaPonto) * 100)
            ...
            const fcdpNumber = (Number(fcdpReplaceVirgulaPonto) * 100)
            ...
            const fccNumber = (Number(fccReplaceVirgulaPonto) * 100)
            ...
            const apcNumber = (Number(apcReplaceVirgulaPonto) * 100)
            ...
            const apfNumber = (Number(apfReplaceVirgulaPonto) * 100)
            ...
            const apuNumber = (Number(apuReplaceVirgulaPonto) * 100)
            ...
            const fmqNumber = (Number(fmqReplaceVirgulaPonto) * 100)
            ...
            const fmcNumber = (Number(fmcReplaceVirgulaPonto) * 100)
