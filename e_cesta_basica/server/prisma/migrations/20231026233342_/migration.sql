...
-- AddForeignKey
ALTER TABLE "Supermercado" ADD CONSTRAINT "Supermercado_pesquisaIdS_fkey" FOREIGN KEY ("pesquisaIdS") REFERENCES "Pesquisa"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Pesquisa" ADD CONSTRAINT "Pesquisa_PesProdIdPes_fkey" FOREIGN KEY ("PesProdIdPes") REFERENCES "PesProd"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_pesquisaIdU_fkey" FOREIGN KEY ("pesquisaIdU") REFERENCES "Pesquisa"("id") ON DELETE SET NULL ON UPDATE CASCADE;
