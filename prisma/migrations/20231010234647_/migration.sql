...
INSERT INTO "new_User" ("autorizacao_pesquisa", "avatarUrl", "createdAt", "email", "googleId", "id", "matricula", "name", "pesquisaCompIdU", "pesquisaIdU", "tipo") SELECT "autorizacao_pesquisa", "avatarUrl", "createdAt", "email", "googleId", "id", "matricula", "name", "pesquisaCompIdU", "pesquisaIdU", "tipo" FROM "User";
DROP TABLE "User";
